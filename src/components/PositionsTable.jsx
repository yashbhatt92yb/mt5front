            ...
            {positions.length === 0 ? (
              <tr>
                <td colSpan="6" className="px-6 py-12 text-center text-slate-500 italic">
                  {loading ? 'Fetching active positions...' : 'No open positions.'}
                </td>
              </tr>
            ) : (
              positions.map((pos) => (
                <tr key={pos.ticket} className="hover:bg-slate-800/30 transition-colors group">
                  ...
                  <td className="px-6 py-4 text-right font-medium text-slate-200">{pos.open_price}</td>
                  ...
                  <td className="px-6 py-4 text-center">
                    <button
                      ...
                      className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-rose-500/10 text-rose-500 ring-1 ring-rose-500/20 hover:bg-rose-500 hover:text-white transition-all disabled:opacity-50"
                    >
